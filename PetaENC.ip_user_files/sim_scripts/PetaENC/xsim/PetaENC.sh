...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L xil_defaultlib -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PetaENC xil_defaultlib.PetaENC xil_defaultlib.glbl -log elaborate.log
}
