...
design_libs=(axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xil_defaultlib xlconstant_v1_1_7)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PetaENC xil_defaultlib.glbl -o PetaENC_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PetaENC_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nfs/home/m1info3/Documents/TER_FPGA/PetaENC/PetaENC.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key PetaENC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PetaENC_simv.daidir vcs_lib c.obj)
