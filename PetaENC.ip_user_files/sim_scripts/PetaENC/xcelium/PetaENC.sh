...
#
# Script generated by Vivado on Tue Jun 11 12:10:14 CEST 2024
...
#
# Usage        : PetaENC.sh
#                PetaENC.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PetaENC.sh [-reset_run]
#                PetaENC.sh [-reset_log]
#                PetaENC.sh [-help]
#
...
#                script (type 'PetaENC.sh -help' for more information).
#
...
design_libs_elab="-libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname xil_defaultlib -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xil_defaultlib xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "PetaENC.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PetaENC.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.PetaENC xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.PetaENC -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nfs/home/m1info3/Documents/TER_FPGA/PetaENC/PetaENC.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log PetaENC_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PetaENC.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PetaENC.sh [-help]\n\
Usage: PetaENC.sh [-step]\n\
Usage: PetaENC.sh [-lib_map_path]\n\
Usage: PetaENC.sh [-reset_run]\n\
Usage: PetaENC.sh [-reset_log]\n\
Usage: PetaENC.sh [-keep_index]\n\
Usage: PetaENC.sh [-noclean_files]\n\n\
